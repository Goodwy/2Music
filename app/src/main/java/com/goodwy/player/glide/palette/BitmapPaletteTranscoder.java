package com.goodwy.player.glide.palette;
...
public class BitmapPaletteTranscoder implements ResourceTranscoder<Bitmap, BitmapPaletteWrapper> {
    ...
    public Resource<BitmapPaletteWrapper> transcode(Resource<Bitmap> bitmapResource) {
        ...
        BitmapPaletteWrapper bitmapPaletteWrapper = new BitmapPaletteWrapper(bitmap, ToMusicColorUtil.generatePalette(bitmap));
        return new BitmapPaletteResource(bitmapPaletteWrapper, bitmapPool);
    }

    @Override
    public String getId() {
        return "BitmapPaletteTranscoder.com.goodwy.player.glide.palette";
    }
}