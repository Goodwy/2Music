package com.goodwy.player.ui.activities.tageditor;
...
import com.goodwy.player.glide.palette.BitmapPaletteTranscoder;
import com.goodwy.player.glide.palette.BitmapPaletteWrapper;
...
import com.goodwy.player.util.ImageUtil;
import com.goodwy.player.util.LastFMUtil;
...
public class AlbumTagEditorActivity extends AbsTagEditorActivity implements TextWatcher {
    ...
    protected void loadCurrentImage() {
        ...
        setImageBitmap(bitmap, ToMusicColorUtil.getColor(ToMusicColorUtil.generatePalette(bitmap), ATHUtil.resolveColor(this, R.attr.defaultFooterColor)));
                        ...
                        Glide.with(AlbumTagEditorActivity.this)
                                ...
                                .into(new SimpleTarget<BitmapPaletteWrapper>() {
                                    ...
                                    public void onResourceReady(BitmapPaletteWrapper resource, GlideAnimation<? super BitmapPaletteWrapper> glideAnimation) {
                                        ...
                                        setImageBitmap(albumArtBitmap, ToMusicColorUtil.getColor(resource.getPalette(), ATHUtil.resolveColor(AlbumTagEditorActivity.this, R.attr.defaultFooterColor)));
                                        deleteAlbumArt = false;
                                        dataChanged();
                                        setResult(RESULT_OK);
                                    }
    ...
    protected void loadImageFromFile(@NonNull final Uri selectedFileUri) {
        Glide.with(AlbumTagEditorActivity.this)
                ...
                .into(new SimpleTarget<BitmapPaletteWrapper>() {
                    ...
                    @Override
                    public void onResourceReady(BitmapPaletteWrapper resource, GlideAnimation<? super BitmapPaletteWrapper> glideAnimation) {
                        ToMusicColorUtil.getColor(resource.getPalette(), Color.TRANSPARENT);
                        albumArtBitmap = ImageUtil.resizeBitmap(resource.getBitmap(), 2048);
                        setImageBitmap(albumArtBitmap, ToMusicColorUtil.getColor(resource.getPalette(), ATHUtil.resolveColor(AlbumTagEditorActivity.this, R.attr.defaultFooterColor)));
                        deleteAlbumArt = false;
                        dataChanged();
