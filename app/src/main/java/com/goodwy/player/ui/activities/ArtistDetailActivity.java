...
import com.goodwy.player.adapter.album.HorizontalAlbumAdapter;
import com.goodwy.player.adapter.song.ArtistSongAdapter;
import com.goodwy.player.dialogs.AddToPlaylistDialog;
import com.goodwy.player.dialogs.SleepTimerDialog;
import com.goodwy.player.glide.ArtistGlideRequest;
...
import com.goodwy.player.lastfm.rest.model.LastFmArtist;
...
public class ArtistDetailActivity extends AbsSlidingMusicPanelActivity implements PaletteColorHolder, CabHolder, LoaderManager.LoaderCallbacks<Artist> {
    ...
    private void loadArtistImage() {
        ArtistGlideRequest.Builder.from(Glide.with(this), artist)
                ...
                .dontAnimate()
                .into(new ToMusicColoredTarget(artistImage) {
                    @Override
