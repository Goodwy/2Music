...
import com.goodwy.player.adapter.song.AlbumSongAdapter;
...
import com.goodwy.player.glide.ToMusicColoredTarget;
...
import com.goodwy.player.interfaces.PaletteColorHolder;
import com.goodwy.player.lastfm.rest.LastFMRestClient;
import com.goodwy.player.lastfm.rest.model.LastFmAlbum;
import com.goodwy.player.loader.AlbumLoader;
import com.goodwy.player.misc.SimpleObservableScrollViewCallbacks;
import com.goodwy.player.misc.WrappedAsyncTaskLoader;
import com.goodwy.player.model.Album;
import com.goodwy.player.model.Song;
import com.goodwy.player.ui.activities.base.AbsSlidingMusicPanelActivity;
import com.goodwy.player.ui.activities.tageditor.AbsTagEditorActivity;
import com.goodwy.player.ui.activities.tageditor.AlbumTagEditorActivity;
...
public class AlbumDetailActivity extends AbsSlidingMusicPanelActivity implements PaletteColorHolder, CabHolder, LoaderManager.LoaderCallbacks<Album> {
    ...
    private void loadAlbumCover() {
        SongGlideRequest.Builder.from(Glide.with(this), getAlbum().safeGetFirstSong())
                ...
                .dontAnimate()
                .into(new ToMusicColoredTarget(albumArtImageView) {
                    @Override
    ...
    private void setUpSongsAdapter() {
        adapter = new AlbumSongAdapter(this, getAlbum().songs, R.layout.item_list2, false, this);
    ...
    public MaterialCab openCab(int menuRes, @NonNull final MaterialCab.Callback callback) {
        ...
        cab = new MaterialCab(this, R.id.cab_stub)
                ...
                .setBackgroundColor(ToMusicColorUtil.shiftBackgroundColorForLightText(getPaletteColor()))
