...
import com.goodwy.player.misc.SimpleOnSeekbarChangeListener;
import com.goodwy.player.service.MusicService;
...
public class FlatPlayerPlaybackControlsFragment extends AbsMusicServiceFragment implements MusicProgressViewUpdateHelper.Callback {
    ...
    private void setUpPlayPauseButton() {
        ...
        TintHelper.setTintAuto(playPauseButton, fabColor, true);

        playPauseDrawable = new PlayPauseDrawable(getActivity());

        playPauseButton.setImageDrawable(playPauseDrawable); // Note: set the drawable AFTER TintHelper.setTintAuto() was called
        playPauseButton.setColorFilter(MaterialValueHelper.getPrimaryTextColor(getContext(), ColorUtil.isColorLight(fabColor)), PorterDuff.Mode.SRC_IN);
