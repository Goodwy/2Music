package com.goodwy.player.ui.activities.bugreport;
...
import com.goodwy.player.ui.activities.base.AbsThemeActivity;
import com.goodwy.player.ui.activities.bugreport.model.DeviceInfo;
import com.goodwy.player.ui.activities.bugreport.model.Report;
import com.goodwy.player.ui.activities.bugreport.model.github.ExtraInfo;
import com.goodwy.player.ui.activities.bugreport.model.github.GithubLogin;
import com.goodwy.player.ui.activities.bugreport.model.github.GithubTarget;
...
public class BugReportActivity extends AbsThemeActivity {
    ...
    private static final String ISSUE_TRACKER_LINK = "https://github.com/kabouzeid/2Music";
    ...
    private void sendBugReport(GithubLogin login) {
        ...
        GithubTarget target = new GithubTarget("kabouzeid", "2Music");
