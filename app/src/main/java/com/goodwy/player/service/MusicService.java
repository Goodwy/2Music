package com.goodwy.player.service;
...
import com.goodwy.player.appwidgets.AppWidgetBig;
import com.goodwy.player.appwidgets.AppWidgetCard;
import com.goodwy.player.appwidgets.AppWidgetCardDark;
import com.goodwy.player.appwidgets.AppWidgetClassic;
import com.goodwy.player.appwidgets.AppWidgetClassicDark;
import com.goodwy.player.appwidgets.AppWidgetSmall;
import com.goodwy.player.appwidgets.AppWidgetSmallDark;
import com.goodwy.player.glide.BlurTransformation;
import com.goodwy.player.glide.SongGlideRequest;
import com.goodwy.player.helper.ShuffleHelper;
import com.goodwy.player.helper.StopWatch;
...
import com.goodwy.player.provider.HistoryStore;
import com.goodwy.player.provider.MusicPlaybackQueueStore;
import com.goodwy.player.provider.SongPlayCountStore;
import com.goodwy.player.service.notification.PlayingNotification;
import com.goodwy.player.service.notification.PlayingNotificationImpl;
import com.goodwy.player.service.notification.PlayingNotificationImpl24;
import com.goodwy.player.service.playback.Playback;
import com.goodwy.player.util.MusicUtil;
import com.goodwy.player.util.PreferenceUtil;
import com.goodwy.player.util.Util;
...
public class MusicService extends Service implements SharedPreferences.OnSharedPreferenceChangeListener, Playback.PlaybackCallbacks {
    ...
    public static final String PHONOGRAPH_PACKAGE_NAME = "com.goodwy.player";
    ...
    public void onCreate() {
        ...
        sendBroadcast(new Intent("com.goodwy.player.PHONOGRAPH_MUSIC_SERVICE_CREATED"));
    }
    ...
    private void setupMediaSession() {
        ...
        mediaSession = new MediaSessionCompat(this, "2Music", mediaButtonReceiverComponentName, mediaButtonReceiverPendingIntent);
    ...
    public void onDestroy() {
        ...
        sendBroadcast(new Intent("com.goodwy.player.PHONOGRAPH_MUSIC_SERVICE_DESTROYED"));
    }
