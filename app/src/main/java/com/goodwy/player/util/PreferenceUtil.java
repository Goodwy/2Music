package com.goodwy.player.util;
...
public final class PreferenceUtil {
    ...
    public static int getThemeResFromPrefValue(String themePrefValue) {
        switch (themePrefValue) {
            case "dark":
                return R.style.Theme_2Music;
            case "darkNoDivider":
                return R.style.Theme_2Music_NoDivider;
            case "black":
                return R.style.Theme_2Music_Black;
            case "blackNoDivider":
                return R.style.Theme_2Music_Black_NoDivider;
            case "light":
            default:
                return R.style.Theme_2Music_Light;
            case "lightNoDivider":
                return R.style.Theme_2Music_Light_NoDivider;
        }
    }
