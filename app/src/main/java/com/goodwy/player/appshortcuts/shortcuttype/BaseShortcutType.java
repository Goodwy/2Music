package com.goodwy.player.appshortcuts.shortcuttype;
...
import com.goodwy.player.appshortcuts.AppShortcutLauncherActivity;
...
public abstract class BaseShortcutType {
    ...
    static final String ID_PREFIX = "com.goodwy.player.appshortcuts.id.";
